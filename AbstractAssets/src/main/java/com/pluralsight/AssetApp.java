...
public class AssetApp {
    ...
    public static void main(String[] args) {
        ...
        assets.add(new Cash("Birthday Money", "March 5th, 2025", 200, "Family"));
        assets.add(new Cash("Paycheck", "May 15th, 2025", 100, "Year Up United"));
        ...
        for (Asset asset : assets) {
            if (asset instanceof House) {
                ...
                System.out.printf("""
                        ...
                        From: %s
                        ------------------------------------------\n
                        """, cash.getDescription(), cash.getDateAcquired(), cash.getValue(), cash.getFrom());
            }
        }
    }
}
